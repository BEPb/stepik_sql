...
#### В данном модуле рассматриваются основные понятия реляционной модели, а также различные виды SQL запросов к одной таблице базы данных  
 1.1   Отношение (таблица):
   ...
   - 1.1.4. практический вопрос
   - 1.1.5. практический вопрос
   - 1.1.6. практический вопрос
 1.2   Выборка данных  
...
<img src="./art/stepik-certificate-sql.png" alt="sertificate" width="550" height="400">
